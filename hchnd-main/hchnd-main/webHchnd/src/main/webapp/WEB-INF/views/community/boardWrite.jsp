		...
		<div class="editerWritingTitle">
			...
			<div class="editer-row">
				...
				<li id="button" style="list-style:none;">
					<input type="submit" id="writebutton" type="button" style="width: 90px; height: 40px;" value="글쓰기">			
				</li>
			</div>			
			<div class="row">
				<div class="editer-fixableTextArea">
					<textarea name="subject" placeholder="제목을 입력해 주세요." class="textarea-input" style="height: 40px;"></textarea>
